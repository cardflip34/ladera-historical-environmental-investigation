# The California Cattle-Tick Eradication Program

This chapter answers the question this investigation identified as decisive:
**was Orange County ever within the California cattle tick quarantine and eradication area?**

The entire arsenical-dipping hypothesis rested on this unverified foundation. The recommendations
chapter called the question "cheap, decisive in one direction," and noted that a negative answer
would close the hypothesis permanently.

The answer has been obtained from the primary source. **It is not negative.**

---

## 8.1 The source

**MacKellar, W. M., and Hart, G. H. (1911). *Eradicating Cattle Ticks in California*. United
States Department of Agriculture, Bureau of Animal Industry, Circular No. 174.** Reprinted from
...
::: classification fact
**EM-011 · ESTABLISHED FACT · Confidence: High**

**Orange County was classified by the USDA as heavily infested with cattle ticks, and lay south
of the California quarantine line.**

*Supporting evidence.* Circular 174, page 285, lists the counties found "heavily infested" —
San Luis Obispo, Santa Barbara, San Diego, **Orange**, Fresno, and Ventura — with Tulare, Kern,
Kings, Los Angeles, Riverside, San Bernardino, and Madera "infested to a lesser degree." The
same page states that "The loss to the cattle industry south of the quarantine line in
California from ticks has been enormous."

The page records that these counties "comprised 69,755 square miles of territory, and contained
660,027 head of cattle, of which 153,476 were on tick-infested ranges."

*Counter-evidence and limits.* **The classification is at county level.** It does not place a
dipping vat on any specific parcel, on Rancho Mission Viejo, or within the Ladera Ranch
footprint. Orange County covered roughly 800 square miles; this establishes the programme's
geographic scope — nothing more.

*Citation:* MacKellar & Hart (1911), USDA BAI Circular No. 174, p. 285 [S-USDA-C174].
:::
...
|---|---|---|---|
| 1 | The programme applied to Orange County | **Unverified** | **Established** |
| 2 | This ranch dipped cattle, using its own facility | Unevidenced | Unevidenced |
| 3 | The facility stood within or near the footprint | Unevidenced | Unevidenced |
| 4 | Arsenic residue persists at that location | Unevidenced | Unevidenced |
| 5 | Development disturbed or built over it | Unevidenced | Unevidenced |
| 6 | A pathway to human exposure exists | Unevidenced | Unevidenced |

**The first link now holds. The remaining five do not.**

The advance is real but limited. Orange County being heavily tick-infested makes it *more likely*
that cattle operations in the county dipped — the programme existed precisely to compel it. It
does not demonstrate that this particular ranch did, where any facility stood, or that anything
persists.

::: classification open
**EM-012 remains OPEN.** Whether arsenical cattle dipping occurred within the Ladera Ranch
footprint is still unresolved. What has changed is that the question is now *worth* resolving on
a firmer basis: the programme demonstrably reached this county.
:::

## 8.4 Dipping in Orange County, at named locations

A contemporaneous newspaper report establishes that **dipping actually took place in Orange
County, at named locations, under public supervision**.
...
OCR in the source renders several names imperfectly — "Joplln", "Trabuca", "Capistranlo",
"Blxby" — and the corrected readings above are this project's, not the newspaper's text.
...
The **California State Veterinarian's Fifth Biennial Report (1908)**:
...
*Counter-evidence.* **The report gives no location** and names no ranch. It is not attributed to
Rancho Mission Viejo or placed within this footprint.
...
been "driven a distance of some 30 to 35 miles" on the day they were dipped — which shows cattle
were driven long distances to reach dipping facilities.
:::
...
*would* be visible at 1.15 ft/px, so the imagery argument regains some force for that class of
...
Reading "dipping at Capistrano" and "Trabuco canyon" as bracketing Ladera Ranch should be
resisted. "Capistrano" in 1908 usage is a district statement, and the Joplin ranch is in the
upper Trabuco drainage in the Santa Ana Mountains foothills, not on the coastal plain where this
community sits.
:::
...
What is now established is the weaker proposition that **cattle operations in this county dipped,
...
The same report carries a map of infested sections as of 30 June 1912, examined here.
...
**One detail cuts the other way.** The adjoining San Diego County land, hatched almost entirely
on this map, was **Rancho Santa Margarita y Las Flores** — under the same O'Neill and Flood
ownership as Rancho Mission Viejo, and not partitioned from it until the 1940s. Cattle and
management moved between the two holdings. That does not place infestation or a vat on this
footprint, but it means the quarantine line and the ownership line were not the same line.
:::
...
*Counter-evidence:* This **refines and narrows** the "1907–1917" window used in this project's
earlier work — a general California or national approximation rather than an Orange County
finding. These are newspaper reports *of* proclamations, graded B2; the proclamations themselves
have not been read.
:::
...
twelve**. Any facility decommissioned at the programme's end had five more years to disappear than
previously assumed. Combined with correction C-004, the evidential weight of the negative imagery
finding is reduced further.
...
**could not be retrieved** — the server returns HTTP 403 to automated access.

This document would likely date the programme's California commencement precisely and define its
boundaries in the state's own terms. It is recorded as dead end DE-010, retrievable by a person
with an ordinary browser.

## 8.8 The operation, photographed
