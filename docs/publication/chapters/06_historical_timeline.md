...
Every entry carries a source and a confidence level. Entries marked **UNVERIFIED** are recorded
because they appear in secondary accounts and are useful for orientation, but have not been
confirmed against a primary source by this investigation. They should not be relied upon.

Dates in the cattle-tick section are the most rigorously established in this timeline, because
they were the investigation's decisive question and were pursued to primary sources.
...
**The 1867 plat, the 1886 photograph and the 1900 photographs all depict San Diego County** —
Rancho Santa Margarita y Las Flores, now largely Camp Pendleton. That property shared ownership
with Rancho Mission Viejo and was partitioned from it in the 1940s, but **it is different land**.
They are included here to date the shared ownership era, not to depict this study area.
:::

---

## The cattle tick era — the best-established section of this timeline

| Date | Event | Source | Confidence |
|---|---|---|---|
| **Nov 1898** | Infected cattle brought to Riverside "from the San Joaquin ranch, in Orange county"; dipped in **crude oil** | *Los Angeles Herald*, 17 Nov 1898 [S-NEWS-CDNC] | Medium |
| **1903 (14 Apr)** | An "Orange County Cattle Quarantine" is reported — **this concerns ANTHRAX, not ticks.** Recorded here specifically so it is not miscited | *Los Angeles Herald*, 14 Apr 1903 | High |
| **15 Apr 1907** | California Governor's proclamation establishing cattle fever quarantine | **LOCATED BUT NOT RETRIEVED** — California State Library returns HTTP 403 (DE-010) | Medium |
| 28 Jul 1907 | Governor Gillett establishes quarantine against Texas fever; Orange County remains quarantined | *San Francisco Call*, 28 Jul 1907 | Medium |
| **1 Feb 1908** | Gillett proclamation — cited in a later article as the operative instrument | *Los Angeles Herald*, 7 Feb 1909 (citing it) | Medium |
| **27 May 1908** | **Dipping in progress at four named Orange County locations**: the J. C. Joplin ranch in Trabuco Canyon, Capistrano (600–700 head), Yorba, and the Bixby ranch in Santa Ana Canyon. Dr. Coleman, deputy state quarantine officer, consulting with county cattle raisers | ***Los Angeles Herald*, 27 May 1908, p. 10 — READ AND VERIFIED DIRECTLY** [S-NEWS-LAH1908] | **High** |
| **25 Jul 1908** | E. J. Levengood claims $400 against Orange County after six cows died following a dip ordered by county veterinarian **Dr. W. S. McFarlane**, who "supervised the mixing of the preparation used" | *Los Angeles Herald*, 25 Jul 1908 | High |
| 15 Aug 1908 | The Levengood suit reported in the agricultural press | *Pacific Rural Press*, 15 Aug 1908 | High |
| **1909** | USDA Bureau of Animal Industry 26th Annual Report — the observations later reprinted as Circular 174 | [S-USDA-C174] | High |
| 5 Mar 1910 | State veterinarian asks the Orange County board of supervisors for a **second tick inspector** | *Pacific Rural Press*, 5 Mar 1910 | Medium |
| **31 Mar 1910** | Gillett/Keane proclamation quarantining Orange County | *San Francisco Call*, 1 Apr 1910 | Medium |
| **1911** | **USDA BAI Circular 174, *Eradicating Cattle Ticks in California*** published. Page 285 lists **Orange County** among counties "heavily infested"; the county lies **south of the quarantine line**. Pages 295–299 give swim vat, cage vat and wade tank designs and costs; page 293 reproduces the required poison warning | **[S-USDA-C174] — pages 285 and 299 READ AND VERIFIED DIRECTLY** | **High** |
| 18 Oct 1911 | Orange County still quarantined; "only one ranch" reported infected | *Hanford Journal*, 18 Oct 1911 | Medium |
| **7–8 Mar 1912** | **Quarantine lifted.** Proclamation by State Veterinarian Keane, signed by Governor Johnson | *San Francisco Call*, 8 Mar 1912 [S-NEWS-CDNC] | **High** |
| 3 Jul 1915 | California eradication reported complete except part of San Diego County | *Blade Tribune*, 3 Jul 1915 | Medium |

::: classification fact
**The Orange County quarantine window is therefore approximately February 1908 to March 1912.**

This **narrows** the "1907–1917" figure this project used in earlier work, which was a general
California or national approximation rather than an Orange County finding.

It also **works against this investigation's own imagery argument**: a programme ending in March
1912 leaves a **seventeen-year** gap to the earliest aerial photograph (1929), not the twelve
years previously stated.
:::

::: classification limit
**The unnamed "one large ranch."** Where period sources refer to dipping at an unnamed large
ranch, or to "only one ranch" remaining infected, **that reference has not been demonstrated to
be Rancho Mission Viejo.** Southern California had several very large cattle operations in this
era, and the four ranches actually named in 1908 — Joplin, Bixby, and the Capistrano and Yorba
districts — do not include it. Treating an unattributed reference as an identification would be
...
| Date | Event | Source | Confidence |
|---|---|---|---|
| 1940s | Partition separating the Orange County holdings from the Santa Margarita (Camp Pendleton) portion | **UNVERIFIED** — under active research | Low |
| 1942–1948 | Topographic mapping of the area (US Army Corps 1942; USGS 1948) | Referenced in Phase I documents; USGS sheets held | High |
| **1929–1947** | Aerial photography of the footprint flown and archived by Orange County | OC Survey Historic_Imagery_v2 [S-IMG-01] | High |
...
| ~1999 | Ladera Ranch construction begins; "since before 1942 and up to 1999… part of a larger cattle ranch, used for dry farming and grazing" | DTSC EnviroStor, Oso Grande site history [S-OSOGRANDE] | High |
| **Feb 2002** | Oso Grande School Phase I ESA — aerials reviewed: **1952, 1968, 1977, 1989, 1994**. No soil sampling | [S-OSOGRANDE] | High |
...
This is the timeline's central observation, and the reason the investigation exists.

| | Period |
|---|---|
| **Orange County cattle tick quarantine** | ~Feb 1908 – Mar 1912 |
| **Earliest aerial photography that exists** | 1929 |
| **Earliest aerial photography anyone reviewed before development** | **1952** |
| **Ladera Ranch construction** | ~1999 onward |

The environmental review looked back to 1952. The activity of interest ended in 1912. **Forty
years separate them.**

::: classification limit
That gap is a **product of when the assessment was done**, not of how carefully it was done.
Phase I assessments must use *reasonably ascertainable* sources, and the aerial archive
available to consultants in 2002 began in 1952. The 1929–1947 county imagery this project used
is a modern digitisation.

It is a reason to look again. It is not a reason to conclude that anyone should have looked
harder at the time.
:::
