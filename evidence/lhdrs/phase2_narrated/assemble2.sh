...
fadeit seg0.mp4 f0.mp4; fadeit seg0b.mp4 f0b.mp4; fadeit segA.mp4 fA.mp4; fadeit segB.mp4 fB.mp4; fadeit segC.mp4 fC.mp4; fadeit segD.mp4 fD.mp4; fadeit segE.mp4 fE.mp4
printf "file 'f0.mp4'\nfile 'f0b.mp4'\nfile 'fA.mp4'\nfile 'fB.mp4'\nfile 'fC.mp4'\nfile 'fD.mp4'\nfile 'fE.mp4'\n" > list.txt
...
ffmpeg -y -loglevel error -i "$REEL" -i nar_1.mp3 -i nar_2.mp3 -i nar_3.mp3 -i nar_4.mp3 -i nar_5.mp3 -i nar_6.mp3 -filter_complex \
"[0:a]volume=0.32,afade=t=out:st=54:d=3,apad=whole_dur=$TOT[amb];\
[1:a]adelay=1200|1200[n1];[2:a]adelay=$(ms $TA)|$(ms $TA)[n2];[3:a]adelay=$(ms $TB)|$(ms $TB)[n3];\
[4:a]adelay=$(ms $TC)|$(ms $TC)[n4];[5:a]adelay=$(ms $TD)|$(ms $TD)[n5];[6:a]adelay=$(ms $TE)|$(ms $TE)[n6];\
[n1][n2][n3][n4][n5][n6]amix=inputs=6:normalize=0,volume=1.4[nar];\
